    ...
    >
      ...
      >
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-24 rounded-full object-cover" src={'./src/assets/aces.png'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-24 rounded-full object-cover" src={'./src/assets/codechef.png'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-24 rounded-full object-cover" src={'./src/assets/javabrevers.png'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/swift club.png'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/cog.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/gfg.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/cbc.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/cybar shakti.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/bio.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/aws.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/ciemanics soh.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/gdsc.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/gmc.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/groovance.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/iic.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/Leapofgrace.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/Astech.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/Adevnture.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/Muse.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/panchayati.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/shiv.jpg'} alt="userImage2"/>
        ...
        <div className="group flex-shrink-0 flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 h-96 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
            <img className="w-24 h-20 rounded-full object-cover" src={'./src/assets/Tuf.jpg'} alt="userImage2"/>
